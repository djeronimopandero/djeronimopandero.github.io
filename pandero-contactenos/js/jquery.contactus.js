...
(function (b) {
  ...
  d.prototype._initCallbackBlock = function () {
    ...
    var d = b("<form>", { action: this.settings.ajaxUrl, method: "POST" }),
    ...
    b.each(c.settings.callbackFormFields, function (e) {
      var d = b("<div>", {
          class:
            ...
            c.settings.callbackFormFields[e].type +
            " arcu-form-group-" +
            c.settings.callbackFormFields[e].name +
            (c.settings.callbackFormFields[e].required
      ...
      var g = b(h, {
        ...
        class:
          "arcu-form-field arcu-field-" + c.settings.callbackFormFields[e].name,
        required: c.settings.callbackFormFields[e].required,
        type:
          "dropdown" == c.settings.callbackFormFields[e].type
            ? null
            : c.settings.callbackFormFields[e].type,
        value: "",
      ...
      "dropdown" == c.settings.callbackFormFields[e].type &&
        b.each(c.settings.callbackFormFields[e].values, function (a) {
          ...
          "object" == typeof c.settings.callbackFormFields[e].values[a] &&
            ((d = c.settings.callbackFormFields[e].values[a].value),
            (k = c.settings.callbackFormFields[e].values[a].label));
          a = b("<option>", { value: d });
          a.text(k);
          g.append(a);
        });
  ...
  d.prototype._initMessengersBlock = function () {
    ...
    "rounded" == this.settings.itemsIconType
      ? e.addClass("rounded-items")
      : e.addClass("not-rounded-items");
    c.append(e);
    a.append(c);
    this.$element.append(a);
  };
  d.prototype._appendMessengerIcons = function (a) {
    ...
    b.each(this.settings.items, function (e) {
      ...
      var f =
        "rounded" == c.settings.itemsIconType
          ? b("<span>", {
      ...
      "undefined" != typeof this.subTitle &&
        this.subTitle &&
        ((g = b("<div>", { class: "arcu-item-subtitle" })),
        g.text(this.subTitle),
        f.append(g));
      d.append(f);
      e.append(d);
      a.append(e);
  ...
  d.prototype._initMessageButton = function () {
    ...
    var h = b("<div>", { class: "icons hide" }),
      f = b("<div>", { class: "icons-line" });
  ...
  d.prototype._initEvents = function () {
    ...
    a.find(".arcontactus-message-button")
      ...
      .on("mouseup", function (a) {
        if (
          (c.settings.drag && a.pageX === c.x && a.pageY === c.y) ||
          !c.settings.drag
        )
          "regular" == c.settings.mode ? c.toggleMenu() : c.openCallbackPopup(),
            a.preventDefault();
      });
    this.settings.drag &&
      (a.draggable(),
  ...
  d.prototype.startAnimation = function () {
    ...
    this._interval = setInterval(function () {
      ...
      if (l > g) {
        if (l > g + 1) {
          if (m.settings.iconsAnimationPause)
            return (
              m.stopAnimation(),
              setTimeout(function () {
  ...
  b.fn.contactUs = function (a) {
    ...
    return this.each(function () {
      ...
      k ||
        ((k = new d(this, "object" == typeof a && a)),
        e.data("ar.contactus", k));
